...
import { Users, Shield, Clock, MessageCircle, FileText, Settings } from "lucide-react";
  ...
  const guidelines = [
    {
      ...
      description: "Share your stories and listen to others with empathy and understanding."
    },
    {
      icon: Clock,
      title: "Are you above 18?",
      description: "Only use this website if you're about 18 years of age."
    },
    {
      icon: Shield,
      title: "Maintain Anonymity",
      description: "Protect your identity and the privacy of others. Do not share personal information."
    },
    {
      icon: Settings,
      title: "No Harassment or Discrimination",
      description: "Engage in respectful dialogue. Avoid offensive language, personal attacks, and bullying."
    },
    {
      icon: FileText,
      title: "Content Appropriateness",
      description: "Keep discussions relevant to trauma and recovery. Avoid unrelated or inappropriate content."
    },
    {
      icon: MessageCircle,
      title: "No Spam or Self-Promotion",
      description: "Do not promote products, services, or external links without permission."
    },
    {
      icon: Users,
      title: "Seek Professional Help When Needed",
      description: "If you or someone close is in immediate danger, seek professional help. This app is not a substitute for therapy."
    }
  ];
        ...
        <div className="w-full max-w-2xl mx-auto">
          ...
          <div className="space-y-4 mb-8">
            {guidelines.map((guideline, index) => {
              ...
              return (
                <div key={index} className="flex items-start gap-4 p-4 traumedy-card">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              ...
              <Button
                onClick={() => navigate("/chat?mode=video")}
                className="flex-1 py-4 bg-[hsl(var(--traumedy-darker))] hover:bg-[hsl(var(--traumedy-border))] text-[hsl(var(--traumedy-text))] border border-[hsl(var(--traumedy-border))] rounded-lg transition-colors"
                variant="outline"
              >
                Video Call
